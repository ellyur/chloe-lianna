...
const MemorableMomentsSection = () => {
  ...
  const images = [
    { src: prenup1, fullSrc: prenup1, alt: "Pre-debut photo 1", height: "h-80" },
    { src: prenup2, fullSrc: prenup2, alt: "Pre-debut photo 2", height: "h-72" },
    { src: prenup3, fullSrc: prenup3, alt: "Pre-debut photo 3", height: "h-80" },
    { src: prenup4, fullSrc: prenup4, alt: "Pre-debut photo 4", height: "h-64" },
    { src: prenup5, fullSrc: prenup5, alt: "Pre-debut photo 5", height: "h-64" },
    { src: prenup6, fullSrc: prenup6, alt: "Pre-debut photo 6", height: "h-72" },
    { src: prenup7, fullSrc: prenup7, alt: "Pre-debut photo 7", height: "h-80" },
    { src: prenup8, fullSrc: prenup8, alt: "Pre-debut photo 8", height: "h-72" },
    { src: prenup10, fullSrc: prenup10, alt: "Pre-debut photo 10", height: "h-64" },
    { src: prenup11, fullSrc: prenup11, alt: "Pre-debut photo 11", height: "h-72" },
    { src: prenup12, fullSrc: prenup12, alt: "Pre-debut photo 12", height: "h-80" }
  ];
