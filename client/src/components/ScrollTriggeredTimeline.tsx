...
import { Heart, Users, Wine, PartyPopper, Sparkles, Camera } from 'lucide-react';
...
const timelineEvents: TimelineEvent[] = [
    ...
    },
    {
        ...
        description: "The celebration begins as we honor Lianna Chloe's journey into adulthood.",
        icon: Sparkles,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "7:30 PM",
        event: "Dinner",
        description: "Enjoy a delicious feast and share in the joy of this special evening.",
        icon: Wine,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "8:15 PM",
        event: "Second Part of The Event",
        description: "The celebration continues with more festivities and memorable moments.",
        icon: Heart,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "9:30 PM",
        event: "After Party",
        description: "Dance the night away and celebrate this milestone together.",
        icon: PartyPopper,
        hueA: 40,
        hueB: 40,
    },
    ...
    return (
        ...
        >
            ...
            <motion.div 
                ...
                transition={{ duration: 0.8, ease: "easeOut" }}
            >
                <div className="bg-white backdrop-blur-sm rounded-2xl p-8 shadow-green">
                    <div className="mb-4">
                    ...
                    <p className="text-sm md:text-base text-muted-foreground mb-4">
                        Help us capture moments on this special day by using the hashtag
                    </p>
                    <div className="inline-block border-2 border-primary rounded-lg px-4 md:px-6 py-3 bg-[#ffffff] max-w-full">
                        <p className="text-primary text-sm sm:text-base md:text-lg break-all" style={{ fontFamily: 'Satoshi, sans-serif' }} data-testid="text-hashtag">#LiannaAt18</p>
                    </div>
                </div>
            </motion.div>
            {/* Bottom Decorative */}
