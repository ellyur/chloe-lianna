      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="relative -mt-32 md:-mt-40 px-4 md:px-8 pb-8">
            <motion.div 
              className="bg-white backdrop-blur-sm rounded-2xl p-8 md:p-12 max-w-2xl mx-auto shadow-green"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                ...
                >
                  Your presence is the greatest gift I could ever receive.
                  <br /><br />
                  Should you wish to extend your generosity, a token of love and support toward my new chapter would be deeply appreciated.
                  <br /><br />
